...
const filteredInventors = inventors.filter((bornIn1500s) => {
    return bornIn1500s.year > 1499 && bornIn1500s.year < 1600

});
veryOldInventors.push(filteredInventors)
...
const year = inventors.sort((a,b) => a.year - b.year);
sortedByBirthYear.push(year)
...
// Check your return value:
console.log('Exercise 4 My Result: ', adas)
